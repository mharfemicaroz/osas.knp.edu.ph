...
import {
    ...
    mdiTrashCan,
    mdiDotsHorizontal,
    mdiCancel,          // 👈 for Cancel
    mdiPrinter,        // 👈 for Print
} from '@mdi/js'

const props = defineProps({ row: { type: Object, required: true }, moderator: { type: Boolean, default: false }, })
