...
import CardBoxComponentBody from '@/components/commons/CardBoxComponentBody.vue'
import CardBoxComponentFooter from '@/components/commons/CardBoxComponentFooter.vue'
